    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-emerald-50">
     ...
     <main className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-4 pt-0 pb-6 md:grid-cols-2">
		...
		Understand college costs in seconds
          ...
          <p className="mt-4" style={{ color: "#00008B", fontFamily: "serif", fontSize: "15px" }}>
            Type a school to see real data, then estimate grants, loans, and out-of-pocket at a glance.
          </p>

          {/* Target School search */}
          <div className="mt-6 w-full max-w-xl">
            <label className="mb-1 block text-sm font-semibold" style={{ color: "#d00" }}>
              Target School
            </label>
          ...
          <div className="mt-6 grid max-w-xl grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-sm font-bold" style={{ color: "#00008B" }}>
                Household Income
              </label>
              <input
                type="number"
  ...
  <span className="inline-flex items-baseline whitespace-nowrap">
    ...
    {/* Right: donut chart */}
        <section className="rounded-2xl border bg-white p-4 shadow-sm">
          <div className="mb-2 text-sm text-gray-500">Estimated breakdown</div>
